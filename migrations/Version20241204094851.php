 ...
 */
final class Version20241204094851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, parent_id, post_id, author_id, content, created_at, updated_at FROM comment');
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, post_id INTEGER NOT NULL, author_id INTEGER NOT NULL, content CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('INSERT INTO comment (id, parent_id, post_id, author_id, content, created_at, updated_at) SELECT id, parent_id, post_id, author_id, content, created_at, updated_at FROM __temp__comment');
